...
{
    // RenderPipelineSettings define settings that can't be changed during runtime. It is equivalent to the GraphicsSettings of Unity (Tiers + shader variant removal).
    // This allows allocation of resources for a given feature.
