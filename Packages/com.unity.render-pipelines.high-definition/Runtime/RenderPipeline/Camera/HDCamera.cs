...
namespace UnityEngine.Rendering.HighDefinition
{
    ...
    {
        // Include the functions Cinemachine requires
        #region Cinemachine

        [NonSerialized] Camera m_Camera;
        public Camera camera => m_Camera;
        public Vector2 screenSize => new Vector2(m_Camera.pixelWidth, m_Camera.pixelHeight);
        public int actualWidth => m_Camera.pixelWidth;
        public int actualHeight => m_Camera.pixelHeight;
        ...
        public void Reset()
        {
            if (m_Camera != null && m_Camera.TryGetComponent<UniversalAdditionalCameraData>(out var data))
                data.resetHistory = true;
        }

        #endregion // Cinemachine
    }
